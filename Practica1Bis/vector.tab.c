...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_exp = 17,                       /* exp  */
  YYSYMBOL_dot_product = 18                /* dot_product  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "VECTOR", "NUMBER",
  "'+'", "'-'", "'*'", "'/'", "DOT", "CROSS", "'\\n'", "'('", "')'",
  "$accept", "input", "line", "exp", "dot_product", YY_NULLPTR
};
...
{
     -10,     0,   -10,    -9,   -10,   -10,     5,   -10,    16,    -2,
     -10,    13,     5,     5,     5,     5,   -10,   -10,   -10,     3,
       3,   -10,    -1
};
...
{
       2,     3,    10,     4,    12,    13,    14,    11,     4,    17,
      14,     5,     6,    19,    20,    21,    22,     6,    12,    13,
      14,    12,    13,    14,     0,    15,    18,    16
};

static const yytype_int8 yycheck[] =
{
       0,     1,    11,     3,     5,     6,     7,     6,     3,    11,
       7,    11,    12,    12,    13,    14,    15,    12,     5,     6,
       7,     5,     6,     7,    -1,     9,    13,    11
};
...
{
       0,    15,     0,     1,     3,    11,    12,    16,    17,    18,
      11,    17,     5,     6,     7,     9,    11,    11,    13,    17,
      17,    17,    17
};
...
#line 48 "vector.y"
        ...
        free((yyvsp[-1].vector)->vec);
        free((yyvsp[-1].vector));
    }
#line 1167 "vector.tab.c"
    break;

  case 6: /* line: dot_product '\n'  */
#line 54 "vector.y"
                       {
        printf("\tProducto punto: %f\n", (yyvsp[-1].number));
    }
#line 1175 "vector.tab.c"
    break;

  case 7: /* line: error '\n'  */
#line 57 "vector.y"
                 { yyerrok; }
#line 1181 "vector.tab.c"
    break;

  case 8: /* exp: VECTOR  */
#line 61 "vector.y"
           { (yyval.vector) = (yyvsp[0].vector); }
#line 1187 "vector.tab.c"
    break;

  case 9: /* exp: exp '+' exp  */
#line 62 "vector.y"
                  {
        Vector *a = (yyvsp[-2].vector);
        Vector *b = (yyvsp[0].vector);
        if (a->n != b->n) {
            printf("Error: Vectores de dimensiones diferentes (%d vs %d)\n", a->n, b->n);
            exit(1);
        }
        (yyval.vector) = sumaVector(a, b);
        free(a->vec); free(a);
        free(b->vec); free(b);
    }
#line 1203 "vector.tab.c"
    break;
...
#line 73 "vector.y"
        ...
        (yyval.vector) = restaVector(a, b);
        free(a->vec); free(a);
        free(b->vec); free(b);
    }
#line 1219 "vector.tab.c"
    break;
...
#line 84 "vector.y"
        ...
        (yyval.vector) = productoCruz(a, b);
        free(a->vec); free(a);
        free(b->vec); free(b);
    }
#line 1236 "vector.tab.c"
    break;

  case 12: /* exp: '(' exp ')'  */
#line 96 "vector.y"
                  { (yyval.vector) = (yyvsp[-1].vector); }
#line 1242 "vector.tab.c"
    break;

  case 13: /* dot_product: exp DOT exp  */
#line 100 "vector.y"
                {
        Vector *a = (yyvsp[-2].vector);
        Vector *b = (yyvsp[0].vector);
        ...
        (yyval.number) = productoPunto(a, b);
        free(a->vec); free(a);
        free(b->vec); free(b);
    }
#line 1258 "vector.tab.c"
    break;


#line 1262 "vector.tab.c"
